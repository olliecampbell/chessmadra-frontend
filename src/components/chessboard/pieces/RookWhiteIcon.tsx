...
function SvgComponent(props) {
  return (
    ...
    >
      ...
      />
      <Path
        d="M14.777 10.219l2.277-.286c-1.914.312-2.313 5.296-2.313 5.296-.238-.177-.188-4.903.036-5.01zM25.276 9.55c-1.648 0-2.52 2.748-2.52 2.748l.338-2.729zM32.671 9.816l.934.118c-.785.5-1.59 1.989-1.59 1.989zM18.472 20.964l2.62-.293c-2.62.293-4.888 13.113-4.888 13.113z"
