...
export const ChessboardView = ({}) => {
  return <div>mock chessboard component</div>;
};
...
// import BishopBlackIcon from "~/components/chessboard/pieces/BishopBlackIcon";
// import BishopWhiteIcon from "~/components/chessboard/pieces/BishopWhiteIcon";
...
// import KnightBlackIcon from "~/components/chessboard/pieces/KnightBlackIcon";
// import KnightWhiteIcon from "~/components/chessboard/pieces/KnightWhiteIcon";
// import PawnBlackIcon from "~/components/chessboard/pieces/PawnBlackIcon";
// import PawnWhiteIcon from "~/components/chessboard/pieces/PawnWhiteIcon";
// import QueenBlackIcon from "~/components/chessboard/pieces/QueenBlackIcon";
// import QueenWhiteIcon from "~/components/chessboard/pieces/QueenWhiteIcon";
// import RookBlackIcon from "~/components/chessboard/pieces/RookBlackIcon";
// import RookWhiteIcon from "~/components/chessboard/pieces/RookWhiteIcon";
...
// import { BoardTheme, BOARD_THEMES_BY_ID } from "~/utils/theming";
// import { getStatic } from "~/utils/assets";
//
...
//
export const PieceView = ({ piece, pieceSet }: { piece; pieceSet }) => {
  return (
    <img
...
//
// export const ChessboardView = React.forwardRef(
//   (
//     {
//       state,
//       disableDrag,
...
//     };
//
//     const { moveIndicatorAnim, moveIndicatorOpacityAnim, indicatorColor } =
//       state;
//
...
//                   (state.previewedMove?.to &&
//                     square == state.previewedMove?.to))
//               ) {
//                 animated = true;
...
//                                 !isRightEdge &&
//                                   c.borderRight(hiddenColorsBorder)
//                               )
//                           )}
